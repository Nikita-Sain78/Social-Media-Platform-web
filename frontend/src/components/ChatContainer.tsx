...
const ChatContainer = () => {
  ...
  const typingUserNames = Object.keys(typingUsers)
    ...
    .map((id) => users.find((u) => u._id === id)?.fullName)
    .filter(Boolean);
  ...
  console.log(uniqueMessages, "unique");
  ...
  return (
    <div className="flex-1 flex flex-col overflow-auto h-full">
              ...
              <div className="flex flex-col max-w-xs">
                <div
                  className={`px-5 py-1.5 ${
                    message.senderId === authUser?._id
                      ? "bg-purple-500 rounded-tl-4xl rounded-tr-lg rounded-br-4xl rounded-bl-4xl self-end text-white"
                      : "bg-gray-100 rounded-tl-lg rounded-tr-4xl rounded-br-4xl rounded-bl-4xl self-start"
                  }`}
                >
                  {message.image && (
                    <img
      ...
      <div className="flex-1 overflow-y-hidden p-4 space-y-4 overflow-hidden">
        {uniqueMessages.map((message, index) => {
